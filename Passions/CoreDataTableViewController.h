...
// It glues together the UITableView and the NSFetchedResultsController. By answering the
// questions of the TableView with the resources the FetchedResultsController provides.
//
