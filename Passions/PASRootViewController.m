...
- (void)viewDidLoad
{
    ...
    self.pageViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"RootPVC"];
...
- (UINavigationController *)favArtistsNavController
{
	...
	UINavigationController *navController = [self.storyboard instantiateViewControllerWithIdentifier:@"FavArtistsNavController"];
	
	// Create the favorites controller
	PASFavArtistsTVC *favArtistsController = [self.storyboard instantiateViewControllerWithIdentifier:@"PASFavArtistsTVC"];
	
	// put them together and return
	[navController pushViewController:favArtistsController animated:NO];
